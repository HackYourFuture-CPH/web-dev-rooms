...
import { CancelButtonWithEventsStudyGroup } from './CancelButtonWithEventsStudyGroups';
...
export default {
  title: 'Components | CancelButtonWithEventsStudyGroup',
};

export const CardExampleWithHYF = () => (
  <>
    <CancelButtonWithEventsStudyGroup
      path={HYFLogo}
      title="HYF - Week 46"
